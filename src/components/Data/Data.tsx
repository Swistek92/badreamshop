const data = {
  products: [
    ...
    },
    {
      ...
      describe:
        'Białko to niezbędny element diety każdego człowieka, bez którego nie ma mowy o prawidłowym funkcjonowaniu organizmu. To właśnie ono stanowi materiał budulcowy, a także wspiera regenerację pomagając odbudować tkanki.',
